...
export default function DashboardClient({
  ...
  return (
    <IssueListPageClientShell
      activeTab="dashboard"
      title={q.trim().length > 0 ? "Search Results" : "Trending this week"}
      subtitle={
        q.trim().length > 0
          ? `${total} results for "${q}"`
      ...
      emptyStateTitle={q.trim().length > 0 ? "No issues match your query" : "No trending issues match your filters"}
